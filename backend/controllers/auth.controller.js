...
export const signup = async(req, res) => {
    ...
    try{
        ...
        if(password.length < 6){
            ...
            return res.status(400).json({error: "Password must have at least 6 char length"})
        }
...
export const login = async(req, res) => {
    ...
    try{
        ...
        const isPasswordCorrect = await bcrypt.compare(password, user?.password || ""); // without app crash
